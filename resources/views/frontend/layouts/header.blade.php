            ...
            <ul class="wsus__header_right d-flex flex-wrap">
                ...
                {{-- <li>
                    <select class="select_js">
                        ...
                        <option value="">{{ __('Spanish') }}</option>
                    </select>
                </li> --}}
...
<nav class="navbar navbar-expand-lg main_menu main_menu_3">
    ...
    <a class="navbar-brand" href="{{ route('home') }}">
        <img src="{{ asset('images/logo-TJweb-normal.png') }}" alt="Logo" class="img-fluid">
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav m-auto">
            ...
            {{-- Cursos Dropdown Menu --}}
            <li class="nav-item">
                <a class="nav-link" href="#">{{ __('Courses') }} <i class="far fa-angle-down"></i></a>
                <ul class="droap_menu">
                    <li><a href="courses.html">{{ __('Courses') }}</a></li>
                    <li><a href="courses_details.html">{{ __('Courses details') }}</a></li>
                    <li><a href="course_video.html">{{ __('Course video') }}</a></li>
                </ul>
            </li>
            ...
            {{-- Blog Dropdown Menu --}}
            <li class="nav-item">
                <a class="nav-link" href="#">{{ __('Blog') }} <i class="far fa-angle-down"></i></a>
                <ul class="droap_menu">
        ...
        <div class="right_menu">
            ...
            <ul>
                ...
                {{-- User Login --}}
                <li>
                    <a class="common_btn" href="{{ route('login') }}">{{ __('Login') }}</a>
                </li>
